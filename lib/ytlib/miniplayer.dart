...
import 'package:flutter_youtube_ui/ytlib/miniplayer_will_pop_scope.dart';
import 'package:flutter_youtube_ui/ytlib/utils.dart';
                  ...
                  child: GestureDetector(
                    child: ValueListenableBuilder(
                      ...
                      builder: (BuildContext context, double value, Widget? child) {
                        return Opacity(
                          opacity:
                              borderDouble(minRange: 0.0, maxRange: 1.0, value: 1 - value * 0.8),
